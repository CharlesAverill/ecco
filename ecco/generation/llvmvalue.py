...
from .types import NumberType, Array, Struct, EccoUnion
...
class LLVMValue:
    def __init__(
        ...
        union_type: Optional[EccoUnion] = None,
    ):
        ...
        self.union: Optional[EccoUnion] = None
        if array_type:
    ...
    def llvm_type(self) -> str:
        if self.is_num:
            ...
            return f"%union.{self.union.name}{self.references}"
        else:
